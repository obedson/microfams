...
- [ ] investments, units, valuation, subscriptions, redemptions, disclosures;
  ...
  - [ ] Add INV-07 settlement-linked refund-obligation recognition with balanced liability reclassification; provider submission and oversubscribed unit execution remain disabled.
...
- [ ] Group treasury, contributions, projects, committees, meetings, voting, documents, and shared assets.
  ...
  - [ ] Add GT-06B2 disclosed emergency expenditure with mandatory post-hoc ratification.
