...
BEGIN;
DO $$
DECLARE org UUID:='00000000-0000-4000-8000-000000000101'; payer UUID; beneficiary UUID; checker UUID; contract UUID; dispute UUID; result JSONB; replay JSONB; now_at TIMESTAMPTZ:=date_trunc('second',NOW());
BEGIN
