...
for migration in create_organizations.sql repair_group_wallet_ledger.sql add_domain_tenant_ownership.sql add_atomic_group_creation.sql create_feature_flags.sql; do
