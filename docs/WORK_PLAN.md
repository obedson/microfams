...
- [ ] Add identity review, suspension, appeal, retention, and audit workflows.
  ...
  - [x] Add single-purpose suspended-account recovery and appeal tokens.`n  - [ ] Add legal-hold placement/release command history.`n  - [ ] Add the retention item-selection worker.`n  - [ ] Add negative-path trust and recovery E2E coverage.
