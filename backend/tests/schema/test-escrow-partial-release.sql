...
BEGIN
 ...
 BEGIN PERFORM request_escrow_release(org,beneficiary,contract,1,20001,jsonb_build_object('evidence','excess'),'esc07-request-excess',now_at); EXCEPTION WHEN OTHERS THEN failed:=TRUE; END;
